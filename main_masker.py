...
from face_mask_adding.utils import read_info
from face_mask_adding.model.prnet import PRNet
from face_mask_adding.utils.render import render_texture
...
class PRN:
    ...
    def __init__(self, model_path):
        ...
        self.face_ind = np.loadtxt('face_mask_adding/Data/uv-data/face_ind.txt').astype(np.int32)
        self.triangles = np.loadtxt('face_mask_adding/Data/uv-data/triangles.txt').astype(np.int32)
        self.net = PRNet(3, 3)
...
class FaceMasker:
    ...
    def __init__(self, is_aug):
        ...
        Args:
            is_aug(bool): whether or not to add some augmentaion operation on the mask.
        """
        self.uv_face_path = 'face_mask_adding/Data/uv-data/uv_face_mask.png'
        self.mask_template_folder = 'face_mask_adding/Data/mask-data'
        self.prn = PRN('face_mask_adding/model/prnet.pth')
    ...
    def add_mask_one(self, image_path, face_lms, template_name, masked_face_path, image):
